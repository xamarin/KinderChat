			...
			var projects = new List<Solution> {
				...
				new Solution {
					...
					ProjectFiles = new List<string> {
						Path.Combine(path, "" + "../Android/KinderChat.Android.csproj"),
						Path.Combine(path, "../KinderChat.ServerClient/KinderChat.ServerClient.csproj"),
						Path.Combine(path, "../SharedClient/SharedClient.csproj")
					},
				},
				...
				new Solution {
					Name = "iOS",
					ProjectFiles = new List<string> {
						Path.Combine(path, "../iOS/KinderChat.iOS.csproj"),
						Path.Combine(path, "../KinderChat.ServerClient/KinderChat.ServerClient.csproj"),
						Path.Combine(path, "../SharedClient/SharedClient.csproj")
					},
				},
				...
				new Solution {
					Name = "M - iOS",
					ProjectFiles = new List<string> {
						Path.Combine(path, "../Matriarch/Matriarch.iOS/Matriarch.iOS.csproj"),
						Path.Combine(path, "../KinderChat.ServerClient/KinderChat.ServerClient.csproj"),
						Path.Combine(path, "../Matriarch/Matriarch/Matriarch.csproj")
					},
				},
				...
				new Solution {
					Name = "M - Android",
					ProjectFiles = new List<string> {
						Path.Combine(path, "../Matriarch/Matriarch.Droid/Matriarch.Droid.csproj"),
						Path.Combine(path, "../KinderChat.ServerClient/KinderChat.ServerClient.csproj"),
						Path.Combine(path, "../Matriarch/Matriarch/Matriarch.csproj")
					},
				},
				...
				new Solution {
					Name = "M - WP",
					ProjectFiles = new List<string> {
						Path.Combine(path, "../Matriarch/Matriarch.WinPhone/Matriarch.WinPhone.csproj"),
						Path.Combine(path, "../KinderChat.ServerClient/KinderChat.ServerClient.csproj"),
						Path.Combine(path, "../Matriarch/Matriarch/Matriarch.csproj")
					},
				},
				...
				new Solution {
					Name = "M - STore",
					ProjectFiles = new List<string> {
						Path.Combine(path, "../Matriarch/Matriarch.WinStore/Matriarch.WinStore.csproj"),
						Path.Combine(path, "../KinderChat.ServerClient/KinderChat.ServerClient.csproj"),
						Path.Combine(path, "../Matriarch/Matriarch/Matriarch.csproj")
					},
				},
				new Solution {
					Name = "Server",
					ProjectFiles = new List<string> {
						Path.Combine(path, "../KinderChatServer/KinderChatServer.csproj"),
						Path.Combine(path, "../KinderChat.ServerClient/KinderChat.ServerClient.csproj")
					},
				},
				...
				foreach (var projectFile in sln.ProjectFiles)
				{
					...
					foreach (var inc in q)
					{
						...
						if (inc.Contains("Resource.designer.cs") || //auto generated
							...
							inc.EndsWith(".xml") ||
							inc.EndsWith(".axml") ||
							inc.EndsWith(".storyboard") ||
							inc.EndsWith("Theme.cs") ||
							inc.EndsWith(".xib"))
						{
							continue;
						}
